...
class AccountsTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        for ($i = 0; $i < 100; $i++) {
            $password = '1234';
            $birth_day = rand(1960, date("Y") - 18) . '年' . rand(1, 12) . '月' . rand(1, 31) . '日';
            $gender_data = ['男性', '女性'];
            $gender = $gender_data[rand(0, 1)];
            $tel_head = ['050','070', '080', '090'];
            $email_domain = ['@icloud.com', '@gmail.com', '@jcom.zaq.ne.jp', '@yahoo.co.jp'];
            $family_name = [
            ...
            DB::table('accounts')->insert([
                ...
                'name' => $full_name,
                'gender' => $gender,
                'email' => Str::random(rand(5, 15)) . $email_domain[rand(0, 3)],
                'password' => password_hash($password, PASSWORD_DEFAULT),
                'tel' => $tel_head[rand(0, 3)] . rand(1000, 9999) . rand(1000, 9999),
                'introduction' => 'よろしくお願い致します',
                'address1' => $address1[rand(0, 46)],
                'address2' => '市町村',
